...
public class Main {
	...
	public static void main(String args[]) {
		...
		FractalDrawing[] choices = { new SampleFractal (20,15), new DragonCurve (2,30), new SierpinskiTriangle(0,100, new Coordinates (0,600), new Coordinates (400,0), new Coordinates(800,600)), new HilbertCurve(0, 100)}; 
